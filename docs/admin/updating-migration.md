...
3.) If you're using the sources directly from GitHub, you need to build the required assets manually. Please see the chapter [Development Environment](https://github.com/humhub/humhub/blob/develop/docs/develop/intro-build.md#build-production-assets) for more details.
...
2. Download the latest HumHub package directly from [https://download.humhub.com](https://download.humhub.com) and extract it to your webroot or install it via [GitHub/Composer](https://github.com/humhub/humhub/blob/develop/docs/develop/intro-environment.md#installation).
