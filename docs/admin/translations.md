...
:::tip
The [Translation Manager](https://marketplace.humhub.com/module/translation-manager) module, available as part of the the [HumHub Professional Edition](../professional-edition/pe-intro.md) offers a very easy and convenient solution to overwrite all available texts in Humhub.
:::
