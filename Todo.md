...
| S-5     | [x]    | Minor         | `professional-edition/intro.md` — Filename `intro` does not match frontmatter `id: pe-intro`. Sidebar correctly uses the id; rename file to `pe-intro.md` or align the id to `intro`.                                                                          |
